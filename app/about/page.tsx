...
export const metadata: Metadata = {
  title: 'About Us | Shree Maa Financial Consultant',
  description:
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              <SectionHeading
                ...
                description="Shree Maa Financial Consultancy was founded on a simple realisation: securing the right loan is often harder than it should be. Between confusing paperwork, opaque interest rates, and endless bank visits, people give up on good opportunities."
              />
